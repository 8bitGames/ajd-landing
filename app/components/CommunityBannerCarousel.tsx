...
const banners = [
  "/community-banner-1.png",
  "/community-banner-2.png",
  "/community-banner-3.png",
  "/community-banner-4.png",
  "/community-banner-5.png",
];

export default function CommunityBannerCarousel() {
  ...
  useEffect(() => {
    if (isTransitioning) {
      timeoutRef.current = setTimeout(() => {
        ...
        // infiniteBanners = [배너5, 배너1, 배너2, 배너3, 배너4, 배너5, 배너1]
        // index 6 (복제된 배너1) -> index 1 (실제 배너1)
        if (currentIndex === infiniteBanners.length - 1) {
          setCurrentIndex(1);
        }
        // 복제된 마지막 슬라이드(맨 앞)에 도달하면 실제 마지막으로 점프
        // index 0 (복제된 배너5) -> index 5 (실제 배너5)
